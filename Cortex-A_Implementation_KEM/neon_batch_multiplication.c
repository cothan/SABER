...
void schoolbook2x2(uint16_t *restrict c_in_mem,
                   uint16_t *restrict a_in_mem,
                   uint16_t *restrict b_in_mem,
                   const unsigned int iter)
{
    uint16x8x4_t cc[4];         // 16
    uint16x8x2_t aa[4], bb[4];  // 16
    uint16_t *a_mem = a_in_mem, 
             *b_mem = b_in_mem, 
             *c_mem = c_in_mem; 

    cc[0].val[3] = vdupq_n_u16(0);
    cc[1].val[3] = vdupq_n_u16(0);
    cc[2].val[3] = vdupq_n_u16(0);
    cc[3].val[3] = vdupq_n_u16(0);

    // Total SIMD registers: 32
    for (unsigned int i = 0; i < iter; i++)
    {
        aa[0] = vld2q_u16(&a_mem[ 0]);
        bb[0] = vld2q_u16(&b_mem[ 0]);
        aa[1] = vld2q_u16(&a_mem[16]);
        bb[1] = vld2q_u16(&b_mem[16]);
        aa[2] = vld2q_u16(&a_mem[32]);
        bb[2] = vld2q_u16(&b_mem[32]);
        aa[3] = vld2q_u16(&a_mem[48]);
        bb[3] = vld2q_u16(&b_mem[48]);

        sb_vmul(cc[0].val[0], aa[0].val[0], bb[0].val[0]);
        sb_vmul(cc[1].val[0], aa[1].val[0], bb[1].val[0]);
        sb_vmul(cc[2].val[0], aa[2].val[0], bb[2].val[0]);
        sb_vmul(cc[3].val[0], aa[3].val[0], bb[3].val[0]);
        
        sb_vmul(cc[0].val[1], aa[0].val[0], bb[0].val[1]);
        sb_vmul(cc[1].val[1], aa[1].val[0], bb[1].val[1]);
        sb_vmul(cc[2].val[1], aa[2].val[0], bb[2].val[1]);
        sb_vmul(cc[3].val[1], aa[3].val[0], bb[3].val[1]);

        sb_vmla(cc[0].val[1], aa[0].val[1], bb[0].val[0]);
        sb_vmla(cc[1].val[1], aa[1].val[1], bb[1].val[0]);
        sb_vmla(cc[2].val[1], aa[2].val[1], bb[2].val[0]);
        sb_vmla(cc[3].val[1], aa[3].val[1], bb[3].val[0]);

        sb_vmul(cc[0].val[2], aa[0].val[1], bb[0].val[1]);
        sb_vmul(cc[1].val[2], aa[1].val[1], bb[1].val[1]);
        sb_vmul(cc[2].val[2], aa[2].val[1], bb[2].val[1]);
        sb_vmul(cc[3].val[2], aa[3].val[1], bb[3].val[1]);
        
        vst4q_u16(&c_mem[ 0], cc[0]);
        vst4q_u16(&c_mem[32], cc[1]);
        vst4q_u16(&c_mem[64], cc[2]);
        vst4q_u16(&c_mem[96], cc[3]);
